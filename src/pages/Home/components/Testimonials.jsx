...
const Testimonials = () => (
  <section id="clients" className={` flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16 px-6 ${styles.paddingYHome} ${styles.flexCenter} flex-col relative `}>
